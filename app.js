...
// const { NEW_MESSAGE, NEW_MESSAGE_ALERT, START_TYPING_CHAT, STOP_TYPING_CHAT } = require("./constant/events");
...
const chatRoute = require("./routes/chat");
const adminRoute = require("./routes/admin");
const { NEW_MESSAGE, NEW_MESSAGE_ALERT, START_TYPING_CHAT, STOP_TYPING_CHAT, CHAT_JOINED, CHAT_LEAVED, ONLINE_USERS } = require("./constant/events");
const { getSockets } = require("./lib/helper");
const Message = require("./models/message");
const { socketAuthenticator } = require("./middlewares/Auth");
